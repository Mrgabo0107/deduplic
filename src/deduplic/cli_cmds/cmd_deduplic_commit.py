...
from deduplic.core.deduplic import deduplic_commit
...
def main():
    parser = argparse.ArgumentParser(
        description="Consolidate and persist the changes from '.draft/' into the project root."
    )
    ...
    # Execute the deduplic_commit operation
    try:
        deduplic_commit(project_path)
    except Exception as e:
        print(f"Error during consolidation (deduplic_commit): {e}")
