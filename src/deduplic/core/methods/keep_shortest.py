...
def _build_synthetic_record_shortest(
    rec_a: dict,
    rec_b: dict,
    node_a_id: int,
    node_b_id: int,
) -> dict:
    """Creates synthetic record C selecting the shortest non-empty value for each key."""
    synthetic_record = {}
...
def keep_shortest(
    ...
    """Applies Keep-Shortest deduplication strategy on a specific cluster edge."""
    ...
    synthetic_record = _build_synthetic_record_shortest(rec_a, rec_b, node_a_id, node_b_id)
